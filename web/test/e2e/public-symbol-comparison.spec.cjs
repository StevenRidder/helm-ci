...
test('public symbol detail renders bundled S-101 comparison images', async ({ page }) => {
...
test('public symbol detail reports missing comparison renders without broken images', async ({ page }) => {
