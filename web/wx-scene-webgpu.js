...
(function (global) {
  ...
  var gpu = null;         // { device, format, pipeline, sampler, ramps:{} }
  ...
  global.HelmWxSceneGPU = { supported: supported, ready: ensurePipeline, colorizeBitmap: colorizeBitmap, rampTexture: rampTexture };
