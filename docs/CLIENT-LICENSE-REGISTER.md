...
> and [LICENSE.BSL](../LICENSE.BSL) (the BSL-1.1→Apache-2.0 posture decided in
> [ADR-0003](decisions/0003-license-posture.md) /
> [ADR-0010](decisions/0010-distribution-and-packaging-posture.md)). This doc does not restate them.
...
- **IP-counsel sign-off** before any *commercial* distribution that depends on the GPL engine — the
  ...
  ([ADR-0003](decisions/0003-license-posture.md),
  [ADR-0010](decisions/0010-distribution-and-packaging-posture.md),
