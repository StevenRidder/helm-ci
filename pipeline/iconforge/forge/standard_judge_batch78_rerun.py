"""Judge rerun for owned repair batch 78 mixed symbol slice.

Run:
  python3 -m forge.standard_judge_batch78_rerun
"""
...
OUT_JSON = CATALOG / "standard_judge_batch_078_rerun.json"
OUT_MD = CATALOG / "standard_judge_batch_078_rerun.md"
BATCH_ID = "standard_judge_batch_078_rerun"
CREATED_AT = "2026-07-03T00:00:00Z"
SOURCE_BATCH = "catalog/owned_repair_batch78.json"

PASS_ASSETS = {
    "DISMAR03": "distance mark preserves the magenta distance/text cue.",
    "DISMAR04": "distance point with no mark preserves the magenta km text cue.",
    "LITFLT10": "red/white light float preserves the float body, light, and red/white colour semantics.",
    "LITFLT61": "green light float preserves the float body, light, and green colour semantics.",
    "LITVES60": "red light vessel preserves the vessel body and light cue closely enough for human review.",
    "LITVES61": "green light vessel preserves the vessel body and light cue closely enough for human review.",
    "OWNSHP01": "own-ship constant-size symbol preserves the concentric-circle cue.",
    "OWNSHP05": "own-ship to-scale symbol preserves the elongated vessel outline cue.",
    "RFNERY01": "refinery mark preserves the circular refinery/well witness family.",
    "RFNERY11": "conspicuous refinery mark preserves the black circular refinery/well witness family.",
}

FAILS = {
    "SCALEB10": {
        "confidence": 0.90,
        "observed": "The repaired SVG renders as a solid orange capped I-beam, but the OpenCPN/Chart 1 witness is a segmented one-mile vertical scale bar with alternating coloured ticks.",
        "required_change": "Redraw SCALEB10 as the segmented one-mile vertical scale bar witness with alternating ticks/segments; do not use a solid capped I-beam.",
        "codes": ["wrong_scalebar_silhouette", "missing_segment_pattern", "reference_mismatch"],
    },
    "SCALEB11": {
        "confidence": 0.90,
        "observed": "The repaired SVG renders as a solid black capped I-beam, but the witness is a segmented 10-mile latitude scale bar with visible dash/tick segments.",
        "required_change": "Redraw SCALEB11 as the segmented 10-mile vertical latitude scale witness with visible tick/dash segments; do not use a solid capped I-beam.",
        "codes": ["wrong_scalebar_silhouette", "missing_segment_pattern", "reference_mismatch"],
    },
}
