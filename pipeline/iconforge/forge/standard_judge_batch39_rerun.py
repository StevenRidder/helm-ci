"""Judge rerun for owned repair batch 39 NMKINF notice-mark slice.

Run:
  python3 -m forge.standard_judge_batch39_rerun
"""
...
OUT_JSON = CATALOG / "standard_judge_batch_039_rerun.json"
OUT_MD = CATALOG / "standard_judge_batch_039_rerun.md"
BATCH_ID = "standard_judge_batch_039_rerun"
CREATED_AT = "2026-07-03T00:00:00Z"
SOURCE_BATCH = "catalog/owned_repair_batch39.json"

PASS_ASSETS = {
    "NMKINF25": "secondary-waterway-left notice panel preserves the OpenCPN sign family and branch cue.",
    "NMKINF26": "secondary-waterway/main-fairway-right notice panel preserves the OpenCPN sign family and branch cue.",
    "NMKINF27": "secondary-waterway/main-fairway-left notice panel preserves the OpenCPN sign family and branch cue.",
    "NMKINF28": "secondary-waterway-left/main-fairway-right notice panel preserves the OpenCPN sign family and branch cue.",
    "NMKINF29": "secondary-waterway-right/main-fairway-left notice panel preserves the OpenCPN sign family and branch cue.",
    "NMKINF40": "telephone notice panel is a recognizable handset-style information mark.",
    "NMKINF43": "waterski notice panel is a recognizable skier-on-water silhouette.",
    "NMKINF44": "sailing-boats notice panel is a recognizable sailboat silhouette.",
    "NMKINF45": "non-powered boat notice panel is a recognizable small-boat silhouette.",
    "NMKINF46": "windsurfing notice panel is a recognizable board-and-sail silhouette.",
    "NMKINF47": "nautical radio notice panel preserves the VHF text cue.",
    "NMKINF48": "waterscooter/jetski notice panel is a recognizable rider-and-watercraft silhouette.",
    "NMKINF49": "high-speed motorboat notice panel is a recognizable fast-boat silhouette.",
    "NMKINF50": "slipping-of-boats notice panel is a recognizable slipway/ramp-and-boat silhouette.",
}

FAILS = {
    "NMKINF38": {
        "confidence": 0.91,
        "observed": "The repaired SVG renders as a white X in a blue notice panel, but the OpenCPN/Chart 1 witness for end of prohibition or regulation is a single diagonal white slash.",
        "required_change": "Redraw NMKINF38 as the end-of-prohibition/regulation notice mark: blue square panel with one single diagonal white slash only, not an X.",
        "codes": ["wrong_notice_mark_silhouette", "extra_stroke_changes_meaning", "reference_mismatch"],
    },
    "NMKINF53": {
        "confidence": 0.89,
        "observed": "The repaired SVG renders as three stacked boat/hull shapes, but the witness is the maximum-number-of-vessels sign with three simple side-by-side vertical white bars.",
        "required_change": "Redraw NMKINF53 as the maximum number of vessels side-by-side marker with three vertical white bars in the notice panel; do not use stacked hull shapes.",
        "codes": ["wrong_notice_mark_silhouette", "wrong_symbol_family", "reference_mismatch"],
    },
}
...
def _expected(row: dict) -> str:
    ...
    shape = brief.get("required_shape") or "exact notice-mark silhouette"
