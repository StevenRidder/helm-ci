...
def _authority_trace_gate(
    *,
    ...
    if not trace:
        return {
            ...
            "blocker_summary": {
                ...
                "warning_gap_count": 0,
                "runtime_blocker": True,
                "blocker_category_counts": {"authority_trace_missing": 1},
                "source_layer_counts": {"authority_trace": 1},
                "runtime_effect_counts": {"blocks_runtime": 1},
                "severity_counts": {"blocker": 1},
                "top_blocker_categories": {"authority_trace_missing": 1},
            },
            "gap_classifications": [{
                "reason_code": "authority_trace:trace_row_missing",
                "blocker_category": "authority_trace_missing",
                "source_layer": "authority_trace",
                "severity": "blocker",
                "runtime_effect": "blocks_runtime",
                "blocks_runtime": True,
                "remediation_hint": "Regenerate authority_trace_gate.json so the backend row has trace evidence.",
                "evidence": {"report_path": str(AUTHORITY_TRACE)},
            }],
    ...
    return {
        ...
        "blocker_summary": trace.get("blocker_summary") or {},
        "gap_classifications": trace.get("gap_classifications") or [],
