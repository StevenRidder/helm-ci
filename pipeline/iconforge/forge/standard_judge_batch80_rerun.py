"""Judge rerun for owned repair batch 80 unit/vector slice.

Run:
  python3 -m forge.standard_judge_batch80_rerun
"""
...
OUT_JSON = CATALOG / "standard_judge_batch_080_rerun.json"
OUT_MD = CATALOG / "standard_judge_batch_080_rerun.md"
BATCH_ID = "standard_judge_batch_080_rerun"
CREATED_AT = "2026-07-03T00:00:00Z"
SOURCE_BATCH = "catalog/owned_repair_batch80.json"

PASS_ASSETS = {
    "UNITFTH1": "fathom-unit boundary mark preserves the orange F text cue.",
    "UNITMTR1": "metre-unit boundary mark preserves the orange M text cue.",
    "VECGND01": "ownship course/speed-over-ground arrowhead preserves the black double-chevron cue.",
    "VECGND21": "ARPA/AIS course/speed-over-ground arrowhead preserves the green double-chevron cue.",
    "VTCLMK01": "vertical clearance mark preserves the black vertical gauge/clearance witness family.",
}

FAILS = {
    "VECWTR01": {
        "confidence": 0.90,
        "observed": "The repaired SVG renders as a black double-chevron arrowhead, but the OpenCPN witness for course/speed through the water is a single-chevron arrowhead.",
        "required_change": "Redraw VECWTR01 as the black single-chevron through-water vector arrowhead; do not reuse the double-chevron over-ground shape.",
        "codes": ["wrong_vector_arrow_family", "ground_water_vector_confusion", "reference_mismatch"],
    },
    "VECWTR21": {
        "confidence": 0.90,
        "observed": "The repaired SVG renders as a green double-chevron arrowhead, but the OpenCPN witness for ARPA/AIS course/speed through the water is a single-chevron arrowhead.",
        "required_change": "Redraw VECWTR21 as the green single-chevron through-water vector arrowhead; do not reuse the double-chevron over-ground shape.",
        "codes": ["wrong_vector_arrow_family", "ground_water_vector_confusion", "reference_mismatch"],
    },
}
