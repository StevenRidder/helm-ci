"""Judge rerun for owned repair batch 72 TOPMAR slice.

Run:
  python3 -m forge.standard_judge_batch72_rerun
"""
...
OUT_JSON = CATALOG / "standard_judge_batch_072_rerun.json"
OUT_MD = CATALOG / "standard_judge_batch_072_rerun.md"
BATCH_ID = "standard_judge_batch_072_rerun"
CREATED_AT = "2026-07-03T00:00:00Z"
SOURCE_BATCH = "catalog/owned_repair_batch72.json"

PASS_ASSETS = {
    "TOPMAR01": "red/green horizontal-banded circular topmark preserves the required colour order.",
    "TOPMAR91": "red compact rectangular topmark preserves the red topmark cue.",
    "TOPMAR92": "green compact rectangular topmark preserves the green topmark cue.",
    "TOPMAR98": "diamond topmark preserves the white/orange diagonal colour cue.",
    "TOPMAR99": "diamond topmark preserves the white/orange diagonal colour cue.",
}

FAILS = {
    "TOPMAR90": {
        "confidence": 0.88,
        "observed": "The repaired SVG renders as a generic downward arrow, but the OpenCPN witness is a pricken point-down topmark with a stem and side/barb detail.",
        "required_change": "Redraw TOPMAR90 as the pricken point-down topmark from the witness: stem with side/barb detail and downward orientation, not a plain arrow.",
        "codes": ["wrong_topmark_silhouette", "missing_pricken_barbs", "reference_mismatch"],
    },
    "TOPMAR93": {
        "confidence": 0.88,
        "observed": "The repaired SVG renders as a generic upward arrow, but the OpenCPN witness is a pricken point-up topmark with a stem and side/barb detail.",
        "required_change": "Redraw TOPMAR93 as the pricken point-up topmark from the witness: stem with side/barb detail and upward orientation, not a plain arrow.",
        "codes": ["wrong_topmark_silhouette", "missing_pricken_barbs", "reference_mismatch"],
    },
}
