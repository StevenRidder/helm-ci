"""Judge rerun for owned repair batch 52 topmark slice.

Run:
  python3 -m forge.standard_judge_batch52_rerun
"""
...
OUT_JSON = CATALOG / "standard_judge_batch_052_rerun.json"
OUT_MD = CATALOG / "standard_judge_batch_052_rerun.md"
BATCH_ID = "standard_judge_batch_052_rerun"
CREATED_AT = "2026-07-03T00:00:00Z"
SOURCE_BATCH = "catalog/owned_repair_batch52.json"

PASS_ASSETS = {
    "TOPSHPT2": "slanted board topmark preserves the red/white vertical band cue.",
    "TOPSHPT3": "slanted board topmark preserves the solid black cue.",
    "TOPSHPT4": "slanted board topmark preserves the black/white vertical band cue.",
    "TOPSHPT5": "slanted board topmark preserves the white/black vertical band cue.",
    "TOPSHPT6": "slanted board topmark preserves the orange/black vertical band cue.",
    "TOPSHPT7": "slanted board topmark preserves the black/orange vertical band cue.",
    "TOPSHPT8;TE('%s'": "slanted board topmark preserves the white/black/white vertical band cue.",
    "TOPSHPU1": "triangle topmark preserves the green triangular witness family.",
    "TOPSHPU2": "triangle topmark preserves the white/red diagonal colour cue.",
}
...
def build() -> dict:
    ...
    result = {
        ...
        "evidence_notes": [
            "Judged current repaired rows from owned_repair_batch52.",
            "Pass means judge_pass_pending_final_approval only; this artifact grants zero final approvals.",
            "Topmark colour order and stripe pattern were treated as load-bearing.",
        ],
        "project": "vulkan",
...
def _write_md(result: dict) -> None:
    lines = [
        "# Standard Judge Batch 052 Rerun",
        "",
        "- Project: `vulkan`",
        "- Task: `FORGE-15`",
        "- Agent: `codex/FORGE-15-judge-loop-current`",
        "- Source batch: `owned_repair_batch52`",
