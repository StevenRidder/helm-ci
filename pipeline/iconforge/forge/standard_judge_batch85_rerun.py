"""Judge rerun for owned repair batch 85 through-water vector slice.

Run:
  python3 -m forge.standard_judge_batch85_rerun
"""
...
OUT_JSON = CATALOG / "standard_judge_batch_085_rerun.json"
OUT_MD = CATALOG / "standard_judge_batch_085_rerun.md"
BATCH_ID = "standard_judge_batch_085_rerun"
CREATED_AT = "2026-07-03T00:00:00Z"
SOURCE_BATCH = "catalog/owned_repair_batch85.json"

PASS_ASSETS = {
    "VECWTR01": "black through-water vector now preserves the single-chevron witness shape.",
    "VECWTR21": "green through-water vector now preserves the single-chevron witness shape.",
}
...
def _expected(row: dict) -> str:
    ...
    shape = brief.get("required_shape") or "single-chevron through-water vector arrowhead"
