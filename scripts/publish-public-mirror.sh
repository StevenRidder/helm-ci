...
HARD_SECRET_RE='(/Users/steveridder|Dropbox|PM_MCP_TOKEN|taikun-plan|plan\.taikunai|sk-(proj|live|test|ant)-[A-Za-z0-9_-]{20,}|sk-[A-Za-z0-9]{48,}|ghp_[A-Za-z0-9_]{20,}|BEGIN (RSA |OPENSSH |EC |DSA )?PRIVATE KEY)'
RUNTIME_GUARD_FILES=(
  web/index.html
  web/style.json
